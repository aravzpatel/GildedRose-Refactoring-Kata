      ...
      if (this.items[i].sellIn < 0) {
        if (this.items[i].name != 'Aged Brie') {
          if (this.items[i].name != 'Backstage passes to a TAFKAL80ETC concert') {
            ...
            this.items[i].quality = this.items[i].quality - this.items[i].quality; /*sets the quality of the backstage passes to 0*/
          }
        } else {
          if (this.items[i].quality < 50) {
            this.items[i].quality = this.items[i].quality + 1; /* increases the quality of aged brie*/
          }
        }
      }
    }
